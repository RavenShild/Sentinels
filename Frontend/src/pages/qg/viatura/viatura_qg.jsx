...
export default function QGViatura() {
    ...
    const fetchData = async () => {
        try {
            // Faz uma requisição para buscar dados da API em http://localhost:8081/qg_viatura
            const res = await fetch(`${dbConfig()}/qg_viatura`);
    ...
    const handleRegistrarSubmit = async (event) => {
        ...
        try {
            ...
            const response = await fetch(`${dbConfig()}/qg_viatura`, {
    ...
    const buscarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.get(`${dbConfig()}/qg_viatura/selectId/${id}`);
    ...
    const atualizarDadosPorId = async (id) => {
        try {
            ...
            const response = await axios.put(`${dbConfig()}/qg_viatura/${id}`, {
    ...
    const deleteRegistro = async (id) => {
        ...
        try {
            const response = await fetch(`${dbConfig()}/qg_viatura/${id}`, {
    ...
    return (
        <>
            ...
            <p className="text-center d-print-none">Entrada e saída de viaturas do QG</p>
            ...
            <div className={`container d-flex flex-column justify-content-center align-items-center ${estiloImpressao.container_local}`}>
                <ImpressaoHeader titulo="Entrada e saída de viaturas do QG" />
